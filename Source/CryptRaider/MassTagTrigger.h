...
#include "MassTagTrigger.generated.h"

/**
 @class mass and tag trigger collision component
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class CRYPTRAIDER_API UMassTagTrigger : public UBoxComponent
{
	GENERATED_BODY()
public:
...
public:
	...
	//* MASS: Lighter interface
	UFUNCTION(BlueprintCallable)
	bool GetMassTriggingState() const;

	//* TAG: Lighter interface
	UFUNCTION(BlueprintCallable)
	bool GetTagTriggingState() const;
...
private:
	...
	//
	bool MassTriggingState{ false };
	//
	bool TagTriggingState{ false };
};
